package com.mycompany.template.repository;
 ...
 */
public class HazelcastAggregatorRepository extends ServiceSupport implements AggregationRepository {
    ...
    public Exchange get(CamelContext camelContext, String key) {
        try {
            ...
            logger.error("Failed to get the exchange: \n" + e.getStackTrace(), e);
        }
        return null;
    }
    ...
    public void lock(String key) {
        try {
            ...
            logger.error("Failed to lock the key: \n" + e.getStackTrace(), e);
        }
    }
    ...
    public void unlock(String key) {
        try {
            ...
            logger.error("Failed to unlock the key: \n" + e.getStackTrace(), e);
        }
    }
    ...
    public void remove(CamelContext camelContext, String key, Exchange exchange) {
        try {
            ...
            logger.error("Failed to remove the exchange: \n" + e.getStackTrace(), e);
        }
    }
